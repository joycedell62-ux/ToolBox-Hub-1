...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Compare two texts line-by-line — additions in green, removals in red.',
    icon: Replace,
    href: '/text-diff',
    category: 'Text Tools',
    isNew: true,
    tags: ['diff', 'compare', 'text', 'changes', 'code', 'difference'],
  },
  {
    title: 'JSON ↔ CSV Converter',
    description: 'Convert JSON arrays to CSV and back — real-time, no upload needed.',
    icon: ArrowLeftRight,
    href: '/json-csv',
    category: 'Developer Tools',
    isNew: true,
    tags: ['json', 'csv', 'convert', 'data', 'spreadsheet', 'developer'],
  },
  {
    title: 'JPG to PDF',
